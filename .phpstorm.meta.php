...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/alexcutler/cutler-tech/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/alexcutler/cutler-tech/public/storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'home','about','skills','requests.create',
'requests.store','login','login.post','register','register.post',
'logout','dashboard','requests.index','requests.show','requests.destroy',
'requests.updateStatus','storage.local',);
        registerArgumentsSet('views', 
'about','auth.login','auth.register','home','master',
'requests','requests.index','requests.show','skills','users.dashboard',
